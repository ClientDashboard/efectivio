    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="bg-primary-500 hover:bg-primary-600 text-white px-4 py-2 rounded-md flex items-center">
          <i className="ri-add-line mr-2"></i> Nuevo Producto
        </button>
      </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900">PROD-001</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">Consultoría Contable</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">Servicios</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="financial-figure text-sm text-gray-900">B/. 75.00/h</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                ...
                {/* More product rows would be mapped here */}
              </tbody>
            </table>
          </div>
        )}
          ...
          <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
              <p className="text-sm text-gray-700">
                Mostrando <span className="font-medium">1</span> a <span className="font-medium">10</span> de <span className="font-medium">42</span> resultados
              </p>
            </div>
            <div>
